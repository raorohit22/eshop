...
const Page = () => {
  ...
  return (
    ...
    >
            ...
            <div className="w-2/4">
              ...
              <div className="mt-2">
                ...
                {isLoading ? (
                  ...
                  <p className="text-red-400">Failed to load sub categories</p>
                ) : (
                  <Controller
                    name="subcategory"
                    control={control}
              ...
              <div className="mt-2">
                <label className="block font-semibold text-gray-300 mb-1">
                  Select Discount Coides (optional)
                </label>
                {discountLoading ? (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {discountCodes?.map((code: any) => (
                      <button
                        type="button"
                        key={code?.id}
                        className={`px-3 py-1 rounded-md font-semibold border ${watch("discountCodes")?.includes(code?.id) ? "bg-blue-600 text-white border-blue-600" : "bg-gray-800 text-gray-300 border-gray-600 hover:bg-gray-700 hover:border-gray-500"} `}
                        onClick={() => {
      ...
      ${activeEffect === value ? "bg-blue-600 text-white " : "bg-gray-700 hover:bg-gray-600"}`}
                    >
                      <Wand size={18} />
                      {label}
                    </button>
